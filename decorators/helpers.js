...
function setSwaggerOkResponse(func, dto, isArray) {
    if (utils_1.swagger) {
        const responses = Reflect.getMetadata(utils_1.swagger.DECORATORS.API_RESPONSE, func) || {};
        ...
        Reflect.defineMetadata(utils_1.swagger.DECORATORS.API_RESPONSE, Object.assign({}, responses, groupedMetadata), func);
    }
}
exports.setSwaggerOkResponse = setSwaggerOkResponse;
function setSwaggerOperation(func, summary = '') {
    if (utils_1.swagger) {
        const meta = Reflect.getMetadata(utils_1.swagger.DECORATORS.API_OPERATION, func) || {};
        Reflect.defineMetadata(utils_1.swagger.DECORATORS.API_OPERATION, Object.assign(meta, { summary }), func);
    }
}
